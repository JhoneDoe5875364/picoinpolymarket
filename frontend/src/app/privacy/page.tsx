  ...
  return (
    <div className="container mx-auto py-12 px-4 sm:px-6 lg:px-8">
      <Card className="max-w-[1400px] mx-auto">
        <CardHeader>
          <CardTitle className="text-xl font-bold font-headline text-center">Privacy Policy</CardTitle>
          <p className="text-muted-foreground text-sm text-center">Last updated: {new Date().toLocaleDateString()}</p>
        </CardHeader>
        <CardContent className="space-y-4 text-muted-foreground">
          <p className="text-sm">This Privacy Policy describes how PredictPix ("we", "us", or "our") collects, uses, and discloses your information when you use our Service.
          </p>

          <h2 className="text-lg font-headline text-foreground pt-4">1. Information We Collect</h2>
          <p className="text-sm">
          ...
          <h2 className="text-lg font-headline text-foreground pt-4">3. Information Sharing</h2>
          <p className="text-sm">We do not sell your personal information. Your Pi username will be publicly associated with your market activity, such as comments or large trades, as is common in blockchain applications. We may share information with third-party service providers for fraud detection or analytics, but only as necessary to provide the Service.</p>
          
          <h2 className="text-lg font-headline text-foreground pt-4">4. Data Security</h2>
          <p className="text-sm">We implement security measures to protect your information. All sensitive backend communication is handled through secure functions, and we do not store private keys or other highly sensitive personal data.</p>

          <h2 className="text-lg font-headline text-foreground pt-4">5. Your Rights</h2>
          <p className="text-sm">As our system is built on a public ledger, transaction data (predictions, amounts) is inherently public. You may request deletion of your account-specific data (like profile information not on the blockchain) by contacting our support.</p>
          
          <h2 className="text-lg font-headline text-foreground pt-4">6. Changes to This Policy</h2>
          <p className="text-sm">We may update this Privacy Policy from time to time. We will notify you of any changes by posting the new policy on this page.</p>
