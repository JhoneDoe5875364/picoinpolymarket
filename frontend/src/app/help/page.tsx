  ...
  return (
    <div className="container mx-auto py-12 px-4 sm:px-6 lg:px-8">
      <Card className="max-w-[1400px] mx-auto">
        <CardHeader>
          <CardTitle className="text-3xl font-bold font-headline">Help Center</CardTitle>
        ...
        <CardContent className="space-y-8 text-muted-foreground">
          <section className="space-y-3">
            <h2 className="text-xl font-headline text-foreground">Getting Started</h2>
            <p>
          ...
          <section className="space-y-3">
            <h2 className="text-xl font-headline text-foreground">Frequently Asked Questions</h2>
