    ...
    <div className="container mx-auto py-12 px-4 sm:px-6 lg:px-8">
      <Card className="max-w-[1400px] mx-auto">
        <CardHeader className="text-center">
          ...
          <CardTitle className="text-xl font-bold font-headline mt-4">About PredictPix</CardTitle>
        </CardHeader>
        <CardContent className="space-y-6 text-muted-foreground">
          ...
          <div className="space-y-4">
            <h2 className="text-lg font-headline text-foreground">Our Mission</h2>
            <p className="text-sm">
            ...
            <h2 className="text-lg font-headline text-foreground">How It Works</h2>
            <p className="text-sm">
            ...
            <h2 className="text-lg font-headline text-foreground">The Pi Advantage</h2>
            <p className="text-sm">
