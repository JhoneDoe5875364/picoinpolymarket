...
class Market(Base):
    ...
    yes_criteria: Mapped[Optional[str]] = mapped_column(Text)
    no_criteria: Mapped[Optional[str]] = mapped_column(Text)
    edge_cases: Mapped[Optional[str]] = mapped_column(Text)
    market_context: Mapped[Optional[str]] = mapped_column(Text)
    admin_clarification: Mapped[Optional[str]] = mapped_column(Text)
    admin_clarification_at: Mapped[Optional[datetime]] = mapped_column(DateTime(timezone=True))
    admin_clarification_by_user_id: Mapped[Optional[str]] = mapped_column(String)
    admin_clarification_by_username: Mapped[Optional[str]] = mapped_column(String)
    resolution_source: Mapped[Optional[str]] = mapped_column(Text)
    resolution_time: Mapped[Optional[datetime]] = mapped_column(DateTime(timezone=True))
